...
public class Run {
	...
	public static void main(String[] args) {
		...
		// orElse(0.0) 괄호안에 0.0을 넣은 이유는 조건에 해당되는게 없을 경우 0.0으로 출력하라고
		...
		people.stream().filter(person -> "서울".equals(person.getAddress())).forEach(System.out::println);
	...
	// 함수형 인터페이스 선언
	@FunctionalInterface		// 이거 인터페이스 함수형이야~컴파일러가 아! 함수형 인터페이스구나
	interface SimpleCal{
