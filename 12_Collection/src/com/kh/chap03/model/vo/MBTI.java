...
public class MBTI {
	...
	public boolean equals(Object obj) {
		...
		// 내 필드랑		매개변수로 받아온애 필드
		if(!this.introversionExtroversion.equals(mbti.introversionExtroversion) || !this.sensingiNtuition.equals(mbti.sensingiNtuition) ||
			!this.thinkingFeeling.equals(mbti.thinkingFeeling) || !this.judgingPerceiving.equals(mbti.judgingPerceiving)) {
			return false;
		}
		return true;
	}
