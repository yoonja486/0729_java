...
public class F_Logical {
	...
	public void method1() {
		 ...
		 * 계획
		 * 
		 * 사용자에게 정수값을 하나 입력받은 후 사용자가 입력한 
		 * 정수 값이 0보다 크면서 짝수인지 판별하고 결과를 출력 
		 */
		...
		int num = sc.nextInt();			
		//System.out.println(num);		// 꼭 먼저 해야할 일 변수 출력해보기
	...
	public void method2() {
		...
		// System.out.println(1 <= number <= 100);
				...
				// 4가지 방법 중에서 2_3번이 보기 쉽다.
		// 2_1. (0 < number) && (number < 101)
		// 2_2. (100 >= number) && (1 <= number)
		// 2_3. (1 <= number) && (number <= 100)		// 이렇게 쓰는게 알아보기 쉽다.
		...
		public void method3() {
			...
			// 사용자에게 한 글자를 입력 받아서 입력받은 값이 'A' 또는 'a'인지 확인해서 출력하기
			Scanner sc = new Scanner(System.in);
