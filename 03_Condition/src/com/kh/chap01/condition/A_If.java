...
public class A_If {
	...
	public void lunchMenu() {
		...
		// 오늘의 날씨를 입력받아서 점심메뉴를 추천해주는 프로그램
		...
		// weather	동등비교	"비옴"
		// System.out.println(weather == "비옴"); -> 문자열값은 동등비교연산자(==)를 사용할 수 없음
		// .equals()를 호출해야함.
		...
		if(weather.equals("맑음")) {
			System.out.println("서브웨이에서 좋아하는거 드세요~");
		}
	}
	...
	public void method3() {
		...
		//			&&
		// 2. 홀 / 짝
		//	  입력받은 정수를 2로 나눈 나머지를 0과 동등비교해서 구함
		//		number % 2		==		0  짝수(true 일 때)
		//	   !number % 2		==		0  홀수(true 일 때)
		
		
		// if()안에 조건식 순서,위치를 어떻게 넣느냐에 따라서 연산 횟수를 줄일 수도 있다.
		// 내가 의도한대로 동작이 가능한가, 어느 부분 개선하면 좋을까
